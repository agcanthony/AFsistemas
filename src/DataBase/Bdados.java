...
public class Bdados
{
    ...
    public static Connection Bdados() throws ClassNotFoundException{
        ...
        Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/afsistemadb","root","");
    ...
    public void conexao(){
        try{
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/afsistemadb?useTimezone=true&serverTimezone=UTC","root","");
